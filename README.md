...
- In Macro Config, create a Macro Type where you will insert your records list. ps.: The order of Types created, will be the order of concatenations. ex.: macro generated: (randomized random action from type1 + randomized random action from type2 +... )<br>
